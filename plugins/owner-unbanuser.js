...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  if (!text) return conn.reply(m.chat, `*❏ UNBAN*\n\n• ${usedPrefix}unban nomer|hari\n*Contoh:* ${usedPrefix}unban 6283854551575|99\n\n• ${usedPrefix}unban nomer\n*Contoh:* ${usedPrefix}6283854551575\n\n• ${usedPrefix}unban @tag|hari\n*Contoh:* ${usedPrefix}unban @6283854551575|99`, m, { mentions: ['6283854551575@s.whatsapp.net'] }, )
  ...
  conn.reply(hl[0],`Hallo, @${hl[0].split('@')[0]} Kamu Telah Di Unbanned, Lain Kali Jangan Spam Ya`, m, { mentions: [hl[0]] }) 
