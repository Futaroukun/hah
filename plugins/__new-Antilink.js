...
export async function before(m, { conn, args, usedPrefix, command, isAdmin, isBotAdmin }) {
    ...
    if (chat.antiLinkTik && isAntiLinkTik) {
        await conn.sendButton(m.chat, `*Link Terdeteksi!*${isBotAdmin ? '' : '\n\n_Bot bukan admin_'}`, author, ['OFF ANTILINKTIK', '/disable antilinktik'], m)
    ...
    await conn.sendButton(m.chat, bottime, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\nJoin Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link Tiktok
    ...
    if (chat.antiLinkBitly && isAntiLinkBitly) {
        await conn.sendButton(m.chat, `*Link Terdeteksi!*${isBotAdmin ? '' : '\n\n_Bot bukan admin_'}`, author, ['OFF ANTILINKBITLY', '/disable antilinkbitly'], m)
        if (isBotAdmin && bot.restrict) {
            // await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
    global.db.data.users[m.sender].limit = 0
    global.db.data.users[m.sender].warn += 1
    ...
    await conn.sendButton(m.chat, bottime, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\n*Join Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link Bitly
    ...
    if (chat.antiLinkYt && isAntiLinkYt) {
        await conn.sendButton(m.chat, `*Link Terdeteksi!*${isBotAdmin ? '' : '\n\n_Bot bukan admin_'}`, author, ['OFF ANTILINKYT', '/disable antilinkyt'], m)
        if (isBotAdmin && bot.restrict) {
            // await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
    global.db.data.users[m.sender].limit = 0
    global.db.data.users[m.sender].warn += 1
    ...
    await conn.sendButton(m.chat, bottime, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\n*Join Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link Youtube
    ...
    if (chat.antiLinkTel && isAntiLinkTel) {
        await conn.sendButton(m.chat, `*Link Terdeteksi!*${isBotAdmin ? '' : '\n\n_Bot bukan admin_'}`, author, ['OFF ANTILINKTEL', '/disable antilinktel'], m)
        if (isBotAdmin && bot.restrict) {
            // await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
    global.db.data.users[m.sender].limit = 0
    global.db.data.users[m.sender].warn += 1
    ...
    await conn.sendButton(m.chat, bottime, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\n*Join Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link Telegram
    ...
    if (chat.antiLinkFb && isAntiLinkFb) {
        await conn.sendButton(m.chat, `*Link Terdeteksi!*${isBotAdmin ? '' : '\n\n_Bot bukan admin_'}`, author, ['OFF ANTILINKFB', '/disable antilinkfb'], m)
        if (isBotAdmin && bot.restrict) {
            // await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
    global.db.data.users[m.sender].limit = 0
    global.db.data.users[m.sender].warn += 1
    ...
    await conn.sendButton(m.chat, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\n*Join Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link Facebook
    ...
    if (chat.antiLinkIg && isAntiLinkIg) {
        await conn.sendButton(m.chat, `*Link Terdeteksi!*${isBotAdmin ? '' : '\n\n_Bot bukan admin_'}`, author, ['OFF ANTILINKIG', '/disable antilinkig'], m)
        if (isBotAdmin && bot.restrict) {
            // await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
    global.db.data.users[m.sender].limit = 0
    global.db.data.users[m.sender].warn += 1
    ...
    await conn.sendButton(m.chat, bottime, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\n*Join Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link Instagram
    ...
    await conn.sendButton(m.chat, bottime, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\nJoin Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link WhatsApp
    ...
    if (chat.antiLinkHttp && isAntiLinkHttp) {
        await conn.sendButton(m.chat, `*Link Terdeteksi!*${isBotAdmin ? '' : '\n\n_Bot bukan admin_'}`, author, ['OFF ANTIHTTP', '/disable antihatetepe'], m)
        if (isBotAdmin && bot.restrict) {
            // await conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
    global.db.data.users[m.sender].limit = 0
    global.db.data.users[m.sender].warn += 1
    ...
    await conn.sendButton(m.chat, bottime, `*Limit Kamu Telah Di Reset*\n*Limit: 0*\n*Warn +1*\n*Join Limit: 0*\n*+ Banned User*
    Karena Kamu Mengirim Link Yang Menggunakan Http
