...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  if (!text) return conn.reply(m.chat, `*❏ BANNED*\n\n• ${usedPrefix}ban nomer|hari\n*Contoh:* ${usedPrefix}ban 6283854551575|99\n\n• ${usedPrefix}ban nomer\n*Contoh:* ${usedPrefix}ban 6283854551575\n\n• ${usedPrefix}ban @tag|hari\n*Contoh:* ${usedPrefix}ban @6283854551575|99`, m)
  ...
  conn.reply(m.chat,`*TERBANNED*\n\nUser telah di banned *@${hl[0].split('@')[0]}* selama *${hl[1]} hari*.\n\n*Banned:*\n${clockString(global.db.data.users[hl[0]].bannedDate - now)}`,m,{ contextInfo: { mentionedJid: [hl[0]] } })
  conn.reply(hl[0],`*TERBANNED*\n\nKamu telah di banned *@${hl[0].split('@')[0]}* selama *${hl[1]} hari*.\n\n*Banned:*\n${clockString(global.db.data.users[hl[0]].bannedDate - now)}`,m,{ contextInfo: { mentionedJid: [hl[0]] } }) 
