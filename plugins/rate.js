...
//conn.sendButton(m.chat, listMessage, global.wm, './media/bank.jpg', [
//[`Inventory`, '.inv'],
 //[`Menu`, '.menu']
//], m, {asLocation: true})
//await conn.sendMessage(m.chat, listMessage)
conn.sendHydrated(m.chat, listMessage, wm, null, sgc, "ðŸŒŽ Group Official", null,null, [['Owner','.owner']], m)
}
