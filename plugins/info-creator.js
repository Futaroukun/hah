...
${htjava} *💌 Nama* : A7 • RAFLI [VZ]🎭
${htjava} *✉️ Nama RL* : M.Rafli Setiawan 
${htjava} *♂️ Gender* : Laki-laki 
${htjava} *🕋 Agama* : Islam
${htjava} *⏰ Tanggal lahir* : 14 Juli 2006
${htjava} *🎨 Umur* : 16
${htjava} *🧮 Kelas* : 11 SMA 
${htjava} *🧩 Hobby* : ∞
${htjava} *💬 Sifat* : ASIK DAH KALAU DAH KENAL
${htjava} *🗺️ Tinggal* : Sukabumi, Jawa Barat, Indonesia 
${htjava} *❤️ Waifu* : Gotou Hitori & Nakano Miku
${htjava} *♥️ Pacar* : Meyga Ayu Prasasti
...
•·––––––––––––––––––––––––––·•
`
  let teks = '\n_Hai kak ini adalah info tentang Ownerku_\n\nPilih dibawah kak ! o(〃＾▽＾〃)o'
const sections = [
   {
	title: `${htjava} OWNER –––––––––·•`,
	rows: [
