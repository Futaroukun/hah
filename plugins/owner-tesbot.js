...
let handler = async (m, { conn, text, usedPrefix }) => {
    const ultah = new Date('Juli 14 2006 23:59:59')
...
`
    ...
    return conn.sendButton(m.chat, hiasan, sewa, await (await fetch(`https://telegra.ph/file/fb70c8eca0191f1f66065.jpg`)).buffer(), [["🗳️MENU", usedPrefix + "menu"], ["🔭DONASI", usedPrefix + "donasi"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        mediaType: 2,
                        ...
                        sourceUrl: 'https://youtube.com/@A7_RAFLI'
            }
        }
    })
}
