...
if (!isNumber(user.phonixlastclaim)) user.phonixlastclaim = 0
        ...
        if (!isNumber(user.intelligence))
              user.intelligence = 0
                ...
                if (!isNumber(user.serigalalastfeed))
                    user.serigalalastfeed = 0
...
esteh: 0,
    ...
    return new Promise(async(resolve, reject) => {
        ...
        resolve(ab)
          ...
          global.kontak2 = [
        ['6285722157719', 'HU TAO BOT-MD', 'Nomer Bot', 'Owner Bot', true],
